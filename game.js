...
let gravity=0.4;// for gravity n bird
...
window.onload = function() {
    ...
    setInterval(treePlaces,1500); // for tree moving gap from left to right
...
function treePlaces(){
    ...
    let bottomTree = {
        img : bottomTreeImg,
        x : treeX,
        y : randomTreeY + treeHeight + Space,//space/somthing for reduce the space b/w the tree //
        width : treeWidth,
        height : treeHeight,
        passed : false
    }
